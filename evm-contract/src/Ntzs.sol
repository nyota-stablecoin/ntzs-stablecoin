...
import "@openzeppelin/contracts-upgradeable/contracts/security/ReentrancyGuardUpgradeable.sol"; // Added for reentrancy protection
    ...
    ReentrancyGuardUpgradeable // Added for reentrancy protection
{
    ...
    function initialize(
        ...
        __ERC20_init_unchained("nTZS", "nTZS");
        __Ownable_init();
        __Pausable_init();
