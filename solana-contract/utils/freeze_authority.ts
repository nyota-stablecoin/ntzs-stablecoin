...
export const transferFreezeAuthority = async (
    newFreezeAuthorityPDA: PublicKey,
    ...
    const transferFreezeAuthorityIx = createSetAuthorityInstruction(
        ...
        newFreezeAuthorityPDA,             // New authority (PDA or wallet)
        [],                                // No multisig
        TOKEN_PROGRAM_ID
    );
    ...
    await verifyFreezeAuthority(connection, mintAddress, newFreezeAuthorityPDA);
};
